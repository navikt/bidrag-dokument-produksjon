import {capitalizeFirstLetter, rolleTilVisningsnavn, søktAvTilVisningsnavn} from "~/utils/visningsnavn";
...
export default function Virkningstidspunkt({data}: { data: NotatDto }) {
    ...
    return <div className={"virkningstidspunkt"}>
        ...
        <div>
            <Datadisplay label={"Søknadstype"} value={capitalizeFirstLetter(virkningstidspunkt.søknadstype)}/>
            <Datadisplay label={"Søkt fra"} value={capitalizeFirstLetter(virkningstidspunkt.søktAv)}/>
            <Datadisplay label={"Mottatt dato"} value={dateToDDMMYYYY(virkningstidspunkt.mottattDato as string)}/>
