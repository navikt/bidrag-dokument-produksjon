...
export default function NotatForskudd() {
    ...
    console.log(data.vedtak[0])
    return (
        <div id="contact">
            <Header/>
            <div>Hello world</div>
            <Heading size={"large"}>asdasdasdasd</Heading>
            <div style={{fontSize: "100px"}}>{data.saksnummer}</div>
            <div style={{fontSize: "100px"}}>{data.vedtak[0].fødselsdato}</div>
        </div>
    );
}
