...
export default function SaksbehandlerNotat({data}: NotatForskuddProps) {
    ...
    return (<div style={{pageBreakBefore: "always"}}>
        ...
        <div>
            ...
            <NotatVisning medIVedtaket innhold={data.virkningstidspunkt.notat.medIVedtaket}/>
            <NotatVisning innhold={data.virkningstidspunkt.notat.intern}/>
        </div>
        <div className="horizontal-line" style={{pageBreakAfter: "avoid", marginTop: "20px"}}></div>

        <div>
            <h3>Boforhold</h3>
            <NotatVisning medIVedtaket innhold={data.boforhold.notat.medIVedtaket}/>
            <NotatVisning innhold={data.boforhold.notat.intern}/>
        </div>
        <div className="horizontal-line" style={{pageBreakAfter: "avoid", marginTop: "20px"}}></div>
        <div>
            <h3>Inntekt</h3>
            <NotatVisning medIVedtaket innhold={data.inntekter.notat.medIVedtaket}/>
