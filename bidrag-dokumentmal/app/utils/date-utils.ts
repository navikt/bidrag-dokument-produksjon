...
export const dateToDDMMYYYY = (date?: Date | string): string | undefined => {
    ...
    if (typeof date == "string")
        return new Date(date).toLocaleDateString("nb-NB", { day: "2-digit", month: "2-digit", year: "numeric" });
    return date.toLocaleDateString("nb-NB", { day: "2-digit", month: "2-digit", year: "numeric" });
};
export const formatPeriode = (dateFom: Date | string, dateTom: Date | string | undefined): string | undefined => {
